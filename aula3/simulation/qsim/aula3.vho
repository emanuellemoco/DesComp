...
-- Dado[1]	=>  Location: PIN_R15,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[2]	=>  Location: PIN_L22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[3]	=>  Location: PIN_R17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[4]	=>  Location: PIN_T22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[5]	=>  Location: PIN_P22,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[6]	=>  Location: PIN_R16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Dado[7]	=>  Location: PIN_M21,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[0]	=>  Location: PIN_N20,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[1]	=>  Location: PIN_M16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[2]	=>  Location: PIN_N16,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Endereco[5]	=>  Location: PIN_K17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[6]	=>  Location: PIN_P16,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[7]	=>  Location: PIN_P17,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[8]	=>  Location: PIN_P18,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- Endereco[9]	=>  Location: PIN_P19,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \memROM~0_combout\ = ( !\Endereco[6]~input_o\ & ( !\Endereco[4]~input_o\ & ( (!\Endereco[8]~input_o\ & (!\Endereco[9]~input_o\ & (!\Endereco[7]~input_o\ & !\Endereco[5]~input_o\))) ) ) )
...
-- Equation(s):
-- \memROM~6_combout\ = ( \Endereco[3]~input_o\ & ( (!\Endereco[1]~input_o\ & (!\Endereco[2]~input_o\ & (\memROM~0_combout\ & !\Endereco[0]~input_o\))) ) ) # ( !\Endereco[3]~input_o\ & ( (\memROM~0_combout\ & ((!\Endereco[1]~input_o\) # 
-- ((!\Endereco[2]~input_o\ & !\Endereco[0]~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000111000001010000010000000000000001110000010100000100000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~1_combout\ = ( !\Endereco[3]~input_o\ & ( (\Endereco[0]~input_o\ & (\memROM~0_combout\ & (\Endereco[1]~input_o\ & !\Endereco[2]~input_o\))) ) )
...
PORT MAP (
	...
	datad => \ALT_INV_Endereco[2]~input_o\,
	datae => \ALT_INV_Endereco[3]~input_o\,
...
-- Equation(s):
-- \memROM~5_combout\ = ( \Endereco[3]~input_o\ & ( (!\Endereco[0]~input_o\ & (\memROM~0_combout\ & (!\Endereco[1]~input_o\ & !\Endereco[2]~input_o\))) ) ) # ( !\Endereco[3]~input_o\ & ( (\memROM~0_combout\ & (((!\Endereco[1]~input_o\) # 
-- (\Endereco[2]~input_o\)) # (\Endereco[0]~input_o\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011000100110011001000000000000000110001001100110010000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[0]~input_o\,
...
-- Equation(s):
-- \memROM~4_combout\ = ( !\Endereco[3]~input_o\ & ( (\memROM~0_combout\ & ((!\Endereco[2]~input_o\ & ((\Endereco[0]~input_o\))) # (\Endereco[2]~input_o\ & (\Endereco[1]~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000100001101000000000000000000000001000011010000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[1]~input_o\,
...
-- Equation(s):
-- \memROM~2_combout\ = ( !\Endereco[3]~input_o\ & ( (!\Endereco[1]~input_o\ & (\Endereco[2]~input_o\ & (\memROM~0_combout\ & !\Endereco[0]~input_o\))) ) )
...
-- Equation(s):
-- \memROM~3_combout\ = ( \Endereco[3]~input_o\ & ( (!\Endereco[0]~input_o\ & (\memROM~0_combout\ & (!\Endereco[1]~input_o\ & !\Endereco[2]~input_o\))) ) ) # ( !\Endereco[3]~input_o\ & ( \memROM~0_combout\ ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0011001100110011001000000000000000110011001100110010000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[0]~input_o\,
